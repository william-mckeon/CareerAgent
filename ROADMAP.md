...
| 24 | Deep code review off a local checkout (careeragent-code) + code-grounded content ideas + nightly repo pre-sync (Slice E) | career-intel | high | P8 | — (a real gap: MCP review is a 6 KB-capped summarizer) |
