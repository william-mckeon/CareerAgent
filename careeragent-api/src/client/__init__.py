# ============================================================================
# careeragent-api - Client Package
# Maintainer: William McKeon
# Outbound HTTP clients for upstream services
# ============================================================================
#
# ROLE:
#   This package holds the outbound client modules careeragent-api uses to
#   talk to its upstream dependencies. One module per upstream service,
#   named by the service being called:
#
#     client/logger.py  — fire-and-forget client for careeragent-logger
#     client/infra.py   — streaming client for careeragent-infra
#     client/memory.py  — session-scoped RAG client for careeragent-memory
...
#   things careeragent-api CALLS rather than the things it SERVES. Keeping
