#!/usr/bin/env python3
# ============================================================================
# careeragent-fetch - inbound auth (X-API-Key: FETCH_API_KEY)
# ============================================================================
...
def _expected_key() -> str:
    ...
    silent 401."""
    return os.environ.get("FETCH_API_KEY", "").strip()
...
async def verify_api_key(x_api_key: str = Header(None, alias="X-API-Key")) -> str:
    ...
    if not expected:
        raise HTTPException(status_code=503, detail="FETCH_API_KEY is not configured")
